...
const tutorialSteps = [
  {
    message: "Hello! Welcome to your study planner!",
    action: () => {
  ...
  {
    message: "Click this button to start planning your study:",
    highlight: "startStudyBtn",
    action: () => {
      // Optionally highlight startStudyBtn
      highlightElement("startStudyBtn");
    }
  },
  {
    ...
    highlight: "taskList",
    action: () => {
      // Hide dashboard, show studyPlannerScreen
      document.getElementById("dashboardSection")?.classList.add("hidden");
      document.getElementById("studyPlannerScreen")?.classList.remove("hidden");
      highlightElement("taskList");
    }
  },
  {
    message: "And here's your plan.",
    highlight: "planBox",
    action: () => highlightElement("planBox")
  },
  {
    message: "Right now its empty. Add a task to your plan:",
    highlight: "firstTask",
    action: () => highlightElement("firstTask")
  },
  {
    message: "Good job! Now fill out the rest of your study.",
  },
  {
    message: "Great! click the popup button to take the timer with you to another tab",
    highlight: "openPopupBtn",
    action: () => highlightElement("openPopupBtn")
  },
  {
    message: "and when you're done with your first task, check it off and the next one will start.",
    highlight: "checkTaskBtn",
    action: () => highlightElement("checkTaskBtn")
  },
  {
    message: "This is your dashboard.",
    action: () => {
      document.getElementById("dashboardSection")?.classList.remove("hidden");
      document.getElementById("studyPlannerScreen")?.classList.add("hidden");
    }
  },
  {
    message: "Here, you can mark tasks completed,",
    highlight: "dashboardTaskList",
    action: () => highlightElement("dashboardTaskList")
  },
  {
    message: "Book tutorials,",
    highlight: "tutorialContainer",
    action: () => highlightElement("tutorialContainer")
  },
  {
    message: "Add tasks to your task list,",
    highlight: "addTaskBtn",
    action: () => highlightElement("addTaskBtn")
  },
  {
    message: "Or edit your tasks.",
    highlight: "dashboardTaskList",
    action: () => highlightElement("dashboardTaskList")
  },
  {
    message: "If your tasks are ever out of date, click the refresh button.",
    highlight: "refreshBtn",
    action: () => highlightElement("refreshBtn")
  },
  {
    message: "Some things to note: if you check off a task, it's gone.",
  },
  {
    message: "This is the settings button.",
    highlight: "settingsBtn",
    action: () => highlightElement("settingsBtn")
  },
  {
    message: "This part's self explanatory.",
  },
  {
    message: "if you have any suggestions, feedback, or questions, please email me!!",
  },
  {
    message: "This project is still a work in progress, so all feedback is greatly appreciated.",
  },
  {
...
function showTutorialStep(step) {
  ...
  const messageBox = document.getElementById('tutorialMessage');
  if (!overlay || !messageBox) return;
  overlay.style.display = 'flex';
  messageBox.textContent = tutorialSteps[step].message;
...
document.getElementById('tutorialOverlay').addEventListener('click', nextTutorialStep);

// Add basic highlight style
const style = document.createElement('style');
style.innerHTML = `.tutorial-highlight { transition: box-shadow 0.3s; box-shadow: 0 0 0 4px #38bdf8 !important; }`;
